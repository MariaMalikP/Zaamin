...
const ManagerHome = (prop) => {
    ...
    const fetchAnnouncements = async () => {
        try {
            const response = await axios.get('https://zaaminbackend.vercel.app/getannouncements');
    ...
    const profilecheck = async () => {
        try {
            ...
            setAlertOpen(true);
            setAlertSeverity('error');
            setAlertMessage('Error navigating to profile home');
        }
    };
    ...
    const medicalnav = async () => {
        try {
            ...
            setAlertOpen(true);
            setAlertSeverity('error');
            setAlertMessage('Error navigating to medical centre');
        }
    };
    ...
    const financenav = async () => {
        try {
            ...
            setAlertOpen(true);
            setAlertSeverity('error');
            setAlertMessage('Error navigating to financial centre');
        }
    };
    ...
    function filterUpcomingAnnouncements(announcements) {
        return announcements.filter(announcement => {
          ...
          console.log("Announcement Date Time:", announcementDateTime);
    ...
    return (
        <div className='home'>
            ...
            <h2>Announcements</h2>
            {filterUpcomingAnnouncements(announcements).length > 0 ? (
